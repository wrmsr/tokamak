...
@Immutable
public final class UnionValueCodec
        implements ValueCodec<Object>
{
    public static final class Entry<T>
    {
        ...
        public Entry(Class<T> cls, byte tag, ValueCodec<T> child)
        {
    ...
    public UnionValueCodec(List<Entry> entries, UnknownClsEncoder unknownClsEncoder, UnknownTagDecoder unknownTagDecoder)
    {
    ...
    public UnionValueCodec(List<Entry> entries)
    {
        this(
                entries,
    ...
    public void encode(Object value, Output output)
    {
        ...
        if (entry == null) {
            ...
            entry.child.encode(value, output);
        }
    }
    ...
    public Object decode(Input input)
    {
        ...
        if (entry == null) {
            ...
            return entry.child.decode(input);
        }
    }
}
