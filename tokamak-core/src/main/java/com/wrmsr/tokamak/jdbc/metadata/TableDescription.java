...
public class TableDescription
{
    ...
    private final Map<String, ColumnMetaData> columnMetaDatasByName;
    private final Map<String, CompositeIndexMetaData> compositeIndexMetaDatasByName;
            ...
            List<CompositeIndexMetaData> compositeIndexMetaDatas)
    {
        ...
        columnMetaDatasByName = columnMetaDatas.stream().collect(toImmutableMap(ColumnMetaData::getColumnName, identity()));
        compositeIndexMetaDatasByName = compositeIndexMetaDatas.stream().collect(toImmutableMap(CompositeIndexMetaData::getIndexName, identity()));
    }
    ...
    public Map<String, ColumnMetaData> getColumnMetaDatasByName()
    {
        return columnMetaDatasByName;
    }

    public Map<String, CompositeIndexMetaData> getCompositeIndexMetaDatasByName()
    {
        return compositeIndexMetaDatasByName;
    }
}
