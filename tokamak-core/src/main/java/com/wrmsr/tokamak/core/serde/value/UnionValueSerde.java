...
@Immutable
public final class UnionValueSerde
        implements ValueSerde<Object>
{
    public static final class Entry<T>
    {
        ...
        public Entry(Class<T> cls, byte tag, ValueSerde<T> child)
        {
    ...
    public UnionValueSerde(List<Entry> entries, UnknownClsEncoder unknownClsEncoder, UnknownTagDecoder unknownTagDecoder)
    {
    ...
    public UnionValueSerde(List<Entry> entries)
    {
        this(
                entries,
