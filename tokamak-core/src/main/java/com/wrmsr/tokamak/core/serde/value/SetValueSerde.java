...
@Immutable
public final class SetValueSerde<V>
        extends CollectionValueSerde<Set<V>>
{
    private final ValueSerde<V> child;

    public SetValueSerde(ValueSerde<V> child, int size, boolean fixed)
    {
        super(size, fixed);
        this.child = checkNotNull(child);
    }

    public SetValueSerde(ValueSerde<V> child)
    {
