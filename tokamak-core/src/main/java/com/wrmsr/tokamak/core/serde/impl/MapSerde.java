...
public final class MapSerde<K, V>
        extends CollectionSerde<Map<K, V>>
{
    private final Serde<K> keyChild;
    private final Serde<V> valueChild;

    public MapSerde(Serde<K> keyChild, Serde<V> valueChild, int size, boolean fixed)
    {
        super(size, fixed);
    ...
    public MapSerde(Serde<K> keyChild, Serde<V> valueChild)
    {
