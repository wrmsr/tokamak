...
public final class BuildStructBuilder
        extends SingleSourceBuilder<PBuildStruct>
{
    public BuildStructBuilder(DriverImpl driver, PBuildStruct node, Map<PNode, Builder> sources)
    {
