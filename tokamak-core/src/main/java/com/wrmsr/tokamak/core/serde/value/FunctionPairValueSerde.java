...
@Immutable
public final class FunctionPairValueSerde<V>
        implements ValueSerde<V>
{
    ...
    public static <V> FunctionPairValueSerde<V> of(
            BiConsumer<V, Output> encoder,
            Function<Input, V> decoder,
            Width width,
            boolean isNullable)
    {
        return new FunctionPairValueSerde<>(encoder, decoder, width, isNullable);
    }
    ...
    public static <V> FunctionPairValueSerde<V> of(
            ...
            Function<Input, V> decoder)
    {
        return new FunctionPairValueSerde<>(encoder, decoder);
    }
