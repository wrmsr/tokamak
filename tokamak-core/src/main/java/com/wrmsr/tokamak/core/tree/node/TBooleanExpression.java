...
public final class TBooleanExpression
        extends TExpression
{
    public enum Op
    {
    ...
    public TBooleanExpression(TExpression left, Op op, TExpression right)
    {
    ...
    {
        return visitor.visitBooleanExpression(this, context);
    }
}
