...
@Immutable
public final class JsonSerde<V>
        implements Serde<V>
{
    private final TypeReference<V> typeReference;
    private final ObjectMapper objectMapper;

    public JsonSerde(TypeReference<V> typeReference, ObjectMapper objectMapper)
    {
        this.typeReference = checkNotNull(typeReference);
        this.objectMapper = checkNotNull(objectMapper);
    }

    public JsonSerde(Class<V> cls, ObjectMapper objectMapper)
    {
        this(Json.typeReference(cls), objectMapper);
    }

    public JsonSerde(TypeReference<V> typeReference)
    {
        this(typeReference, Json.OBJECT_MAPPER_SUPPLIER.get());
    }

    public JsonSerde(Class<V> cls)
    {
