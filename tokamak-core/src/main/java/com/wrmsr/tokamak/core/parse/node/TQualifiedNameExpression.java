...
public final class TQualifiedNameExpression
        extends TExpression
{
    private final TQualifiedName qualifiedName;

    public TQualifiedNameExpression(TQualifiedName qualifiedName)
    {
        this.qualifiedName = checkNotNull(qualifiedName);
    }

    public TQualifiedName getQualifiedName()
    {
    ...
    {
        return visitor.visitQualifiedNameExpression(this, context);
    }
}
