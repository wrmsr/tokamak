 ...
 * com.wrmsr.tokamak.codegen.poet.ClassName#get(String, String, String...)}. To build composite types like {@code char[]} and
...
public class TypeName
{
    ...
    public static final TypeName LONG = new com.wrmsr.tokamak.codegen.poet.TypeName("long");
    ...
    {
        return mirror.accept(new SimpleTypeVisitor7<com.wrmsr.tokamak.codegen.poet.TypeName, Void>()
        {
            @Override
