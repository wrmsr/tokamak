        ...
        extends TestCase
{
            ...
            throws Throwable
    {
        for (String str : new String[] {
            ...
            for (boolean mode : new boolean[] {false, true}) {
                ...
                SqlParser parser = TreeParsing.parse(str);
                TNode node = TreeParsing.build(parser.statement(), new ParsingContext(ParsingOptions.builder().twoQuotesAsEscapedQuote(mode).build()));
                System.out.println(getSelectItemText(node));
            }
            System.out.println();
        }
            ...
            throws Throwable
    {
        for (String str : new String[] {
            ...
            System.out.println(str);
            SqlParser parser = TreeParsing.parse(str);
            TNode node = TreeParsing.build(parser.singleStatement());
            System.out.println(node);
        }
    }
}
