        ...
        extends TestCase
{
            ...
            throws Throwable
    {
        ...
        for (String sql : new String[] {
                "select N_NAME, N_REGIONKEY, R_NAME from NATION join REGION on N_REGIONKEY = R_REGIONKEY where N_REGIONKEY > 5",

                "select N_NAME, N_REGIONKEY, R_NAME from NATION join REGION on N_REGIONKEY = R_REGIONKEY",
                ...
                "select * from NATION join NATION",
